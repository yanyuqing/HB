...
/* function act1(){
    ...
    document.form1.action="binformationList.action";
...
<div align="center">
     ...
     <div>     
  <form id="form1" name="form1" method="post" action="informationBShenheTijiao.action">
   ...
   <s:property value="ifn.TechNeedField"/>
      ...
      <%}
        ...
        <td height="123" colspan="9">审核不通过的理由<textarea name="reason" id="reason" style="width:100% ;height:58px"></textarea></td></tr>
             <tr>
        <td  style="text-align: center;" height="34" colspan="9"> <input type="submit" name="button1" id="button1" value="确定" onclick="return Judge()"/>
