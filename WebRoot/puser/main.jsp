...
<html>
  <head>
   ...
   <%    
    	...
    	String id= request.getAttribute("user.id").toString();
    	String name= request.getAttribute("user.name").toString();
    	String pass= request.getAttribute("user.password").toString();
    	String companyName= request.getAttribute("user.companyName").toString();
    	String legalRepresenttative= request.getAttribute("user.legalRepresenttative").toString();
    	String address= request.getAttribute("user.address").toString();
    	session.setAttribute("id",id);
    	session.setAttribute("pwd",pass);
	    session.setAttribute("username",name);
		session.setAttribute("name",name);
		session.setAttribute("companyName",companyName);								
        session.setAttribute("legalRepresenttative",legalRepresenttative);
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="yes" width="100%" frameBorder=0 id=frmleft name=frmleft src="leftPages/accordition.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
