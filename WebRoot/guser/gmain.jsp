...
<html>
 ...
 <meta http-equiv="pragma" content="no-cache">
    ...
    <body>
    <% 
     String name=request.getAttribute("guser.name").toString(); 
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="yes" width="100%" frameBorder=0 id=frmleft name=frmleft src="leftPages/gaccordition.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
